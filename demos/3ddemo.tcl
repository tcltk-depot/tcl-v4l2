...
set dev [v4l2 open [lindex [v4l2 devices] 0] [list imagecb .w1 $img]]

bind .w1 <Key-space> [list startstop $dev]

v4l2 parameters $dev frame-size 640x480 frame-rate 15
v4l2 start $dev
